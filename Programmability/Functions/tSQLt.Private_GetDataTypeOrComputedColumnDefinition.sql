...
RETURN SELECT 
              ...
              COALESCE(cc.ComputedColumnDefinition, GFTN.TypeName COLLATE database_default) AS ColumnDefinition
       ...
       CROSS APPLY tSQLt.Private_GetFullTypeName(V.UserTypeId, V.MaxLength, V.Precision, V.Scale, V.CollationName COLLATE database_default) AS GFTN
